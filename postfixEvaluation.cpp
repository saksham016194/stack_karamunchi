...
long long postFixEvaluation(char * postfix)
{
        stacke * top=NULL;
        int i=0;
        char ch=postfix[i];
        ...
        {       ch=postfix[i];
                ...
                else if(ch=='+'||ch=='-'||ch=='*'||ch=='/')
                {
                        ...
                        stacke *one=pop(&top);
                        stacke *two=pop(&top);
                        long long first=(one->ch)-'0';
                        long long second=(two->ch)-'0';
                        long long result;
                        switch(ch)
                        {
    ...
    stacke *answer=pop(&top);
    long long ret=(answer->ch)-'0';
    return ret;
}
using namespace std;
int main()
{
        ...
        cout<<"\n answer is"<<postFixEvaluation("123*+5-");
